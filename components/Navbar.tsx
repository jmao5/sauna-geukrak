...
export default function Navbar() {
  ...
  return (
    <nav className="flex h-[56px] w-full items-center justify-around bg-bg-sub border-t border-border-main">
      {NAV_ITEMS.map((item) => {
        const isActive =
        ...
        return (
          <Link
            ...
            className="group relative flex flex-1 flex-col items-center justify-center gap-[2px] py-1 outline-none h-full"
          ...
          >
            ...
            {isActive && (
              <m.div
                ...
                className="absolute top-0 h-[1.5px] w-6 rounded-b-full bg-point"
            ...
            <m.div
              ...
              className={clsx(
                ...
                isActive ? 'text-point' : 'text-text-muted/60',
              )}
            >
              <item.icon size={22} />
            </m.div>
